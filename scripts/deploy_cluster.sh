...
terraform_var_file="$root_dir/talos/terraform/vars/local.tfvars"
terraform_dir="$root_dir/talos/terraform"
ansible_dir="$root_dir/talos/ansible"
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    -t|--terraform-var-file)
      ...
      terraform_var_file="$root_dir/talos/terraform/vars/$(basename "$2")"
      shift 2
